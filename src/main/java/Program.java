...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("ID của nhóm là: " + GroupAccount1.GroupID.GroupID + " và ID của User là: "+ GroupAccount1.AccountID.Accountid);
        ...
        System.out.println("ID của nhóm là: " + GroupAccount2.GroupID.GroupID + " và ID của User là: "+ GroupAccount2.AccountID.Accountid);
        ...
        System.out.println("ID của nhóm là: " + GroupAccount3.GroupID.GroupID + " và ID của User là: "+ GroupAccount3.AccountID.Accountid);
        ...
        System.out.println("ID của câu hỏi là: "+ Question1.CreatorID+ ". Đinh danh của nó là: "+ Question1.TypeID.TypeQuestion);
        ...
        System.out.println("ID của câu hỏi là: "+ Question2.CreatorID+ ". Đinh danh của nó là: "+ Question2.TypeID.TypeQuestion);
        ...
        System.out.println("ID của câu hỏi là: "+ Question3.CreatorID+ ". Đinh danh của nó là: "+ Question3.TypeID.TypeQuestion);
        ...
        System.out.println("Tiêu đề là: "+Exam1.Title+". Đinh danh của chủ đề là: "+ Exam1.CategoryID.CategoryID );
        ...
        System.out.println("Tiêu đề là: "+Exam2.Title+". Đinh danh của chủ đề là: "+ Exam2.CategoryID.CategoryID );
        ...
        System.out.println("Tiêu đề là: "+Exam3.Title+". Đinh danh của chủ đề là: "+ Exam3.CategoryID.CategoryID );
        ...
        ExamQuestion1.QuestionID =Question2;
        System.out.println("ID của đề thi: "+ExamQuestion1.ExamID.ExamID+", đinh danh của câu hỏi: "+ExamQuestion1.QuestionID.QuestionID);

        ExamQuestion ExamQuestion2 = new ExamQuestion();
        ExamQuestion2.ExamID =Exam1;
        ExamQuestion2.QuestionID =Question3;
        System.out.println("ID của đề thi: "+ExamQuestion2.ExamID.ExamID+", đinh danh của câu hỏi: "+ExamQuestion2.QuestionID.QuestionID);

        ExamQuestion ExamQuestion3 = new ExamQuestion();
        ExamQuestion3.ExamID =Exam3;
        ExamQuestion3.QuestionID =Question1;
        System.out.println("ID của đề thi: "+ExamQuestion3.ExamID.ExamID+", đinh danh của câu hỏi: "+ExamQuestion3.QuestionID.QuestionID);
